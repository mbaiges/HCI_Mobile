...
public class DeviceArrayAdapter extends ArrayAdapter<Device> {
    ...
    public DeviceArrayAdapter(Activity context, Device[] objects) {
        ...
        holders = new Object[objects.length];
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        DeviceViewHolder<Device<DeviceState>> holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.device_card_item, parent, false);
            holders[position] = new DeviceViewHolder<Device<DeviceState>>();
            holder = (DeviceViewHolder<Device<DeviceState>>) holders[position];
            ...
            holder = (DeviceViewHolder<Device<DeviceState>>) convertView.getTag();
        }
