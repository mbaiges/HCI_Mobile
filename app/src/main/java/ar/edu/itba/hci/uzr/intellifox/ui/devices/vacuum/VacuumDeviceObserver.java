...
public class VacuumDeviceObserver extends DeviceObserver {
    ...
    protected void findElements() {
        ...
        h.modeBtn[0] = new Pair<>("mop", contextView.findViewById(R.id.mopBtn));
        h.modeBtn[1] = new Pair<>("vacuum", contextView.findViewById(R.id.vacuumBtn));
    }
    ...
    protected void setDescription(DeviceState state) {
        if (state != null) {
            ...
            String bat = s.getBatteryLever().toString();
    ...
    protected void setUI(DeviceState state) {
        ...
        if (state != null) {
            ...
            if (h.modeBtn[0].second != null && s.getMode().equals("mop")) {
                h.modeBtn[0].second.setText(R.string.dev_vacuum_button_mop);
            }
            else if(h.modeBtn[1].second != null && s.getMode().equals("vacuum"))
                h.modeBtn[1].second.setText(R.string.dev_vacuum_button_vacuum);
